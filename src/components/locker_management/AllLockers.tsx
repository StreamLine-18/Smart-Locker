...
export default function AllLockers() {
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      {successMsg && (
        <div className="flex items-center gap-2 p-3 text-green-800 bg-green-100 border border-green-300 rounded-md">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredLockers.map((locker) => (
            <div
              key={locker.id}
              className="border border-gray-200 rounded-lg p-4 bg-white dark:bg-gray-900 dark:border-gray-700 shadow hover:shadow-md transition"
            >
      ...
      {editLocker && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <form
            onSubmit={handleEdit}
            className="bg-white dark:bg-gray-800 p-6 rounded-md shadow-lg w-[90%] max-w-md space-y-4"
          >
      ...
      {deleteId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-md shadow-lg w-[90%] max-w-sm">
